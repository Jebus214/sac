...
oficio.crearInsertForm2('parentF',  [                                       
                                      ...
                                      {input:{label:'Remitente',id:'remitente_e',type:"text"}},
                                      {input:{label:'Dependencia',id:'dependencia_e',type:"text"}},
...
//$('#no_folio').parent().parent().append('<br><br><br><div class="form-group"><label class="control-label col-sm-offset-2 col-sm-2">externo</label><div class="col-sm-6"><input type="checkbox" id="externo" class="js-switch" checked /> externo</div></div>');

//$('<br><br><br><div class="form-group"><label class="control-label col-sm-offset-2 col-sm-2">Interno</label><div class="col-sm-6"><input type="checkbox" id="externo" class="js-switch" checked /> Externo</div></div>').insertBefore($('#no_folio').parent().parent());
...
console.log($('input[type=radio][name=tipo]:checked').val());
